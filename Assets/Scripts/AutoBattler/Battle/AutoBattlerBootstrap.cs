            ...
            for (var i = 0; i < teamConfig.units.Length; i++)
            {
                ...
                for (var unitIndex = 0; unitIndex < count; unitIndex++)
                {
                    ...
                    BattleSpawnUtility.SpawnUnit(
                        ...
                        team,
                        mission,
                        unitConfig.movementInstruction,
                        unitConfig.engagementInstruction,
                        unitConfig.priorityInstruction,
                        worldPosition,
                        targetPoint,
                        unitConfig.ownedUnitCardId,
                        unitConfig.deploymentUnitId,
                        unitConfig.assignedTargetOwnedUnitCardId,
